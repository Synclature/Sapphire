                ...
                <CardBody className="bg-marketplace d-flex">
                  <div className="flex-grow-1">
                    ...
                    <p className="mb-0 mt-2 pt-1 fs-18">
                      Your assessment is complete but you still have work to do
                      before you have fulfilled the <strong>SOC 2</strong>{" "}
              ...
              <div className="card bg-light overflow-hidden">
                <div className="card-body">
                  <div className="d-flex">
                    <div className="flex-grow-1">
                      <h6 className="mb-0">
                        <b className="text-danger">30%</b> High Risk Controls
                      </h6>
                    </div>
              ...
              <div className="card bg-light overflow-hidden">
                <div className="card-body">
                  <div className="d-flex">
                    <div className="flex-grow-1">
                      <h6 className="mb-0">
                        <b className="text-warning">20%</b> Medium Risk Controls
                      </h6>
                    </div>
                    <div className="flex-shrink-0">
                      <h6 className="mb-0">23 of 77</h6>
